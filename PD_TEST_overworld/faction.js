	...
	if (DAY == 1) {
		...
		if(faction.pos) {
			if (emailNum == 1) {
				...
				return ["Supervisor Tresha Brannon", "June 27", "TASK 2", "Reports that Ellis McFarlane has also been smuggling drugs. Find evidence of her connections and smuggling, so the authorities can throw McFarlane even deeper in prison.", "1109", "it was discovered that, Ellis McFarlane, was conducting illegal drug exchanges for the past several months.", "", 2, "Ellis McFarlane"];
			} else if (emailNum == 3) {
